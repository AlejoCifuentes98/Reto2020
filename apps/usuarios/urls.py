...
from .views import login_view, registro_view, registro_medico_view, logout_view, grupo_familiar_view, crear_en_grupo_familiar_view, add_grupo_familiar_view,crear_famillia_view
...
urlpatterns = [
    ...
    path('grupoFamiliar/crear', crear_famillia_view, name='crear_familia'),
